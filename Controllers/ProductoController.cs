...
namespace EMPRESA_QBE.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Descripcion,Precio,ImageName,Marca")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Descripcion,Precio,ImageName,Marca")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
